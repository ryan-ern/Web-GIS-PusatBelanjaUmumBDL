  ...
  return (
    (a.Control.Search = a.Control.extend({
      ...
      _createInput: function (b, c) {
        ...
        return (
          ...
          a.DomEvent.disableClickPropagation(e)
            .on(e, "keydown", this._handleKeypress, this)
      ...
      _createTooltip: function (b) {
        ...
        var d = this;
        return (
          a.DomEvent.disableClickPropagation(c)
      ...
      _recordsFromLayer: function () {
        var c,
          ...
          e = this.options.propertyName;
        return (
          this._layer.eachLayer(function (f) {
              ...
              if (f instanceof a.Marker || f instanceof a.CircleMarker)
                try {
                  if (b(f.options, e))
                    ...
                    if (!b(f.feature.properties, e))
                      throw new Error(
                        "propertyName '" + e + "' not found in marker"
                      );
                    (c = f.getLatLng()),
                      (c.layer = f),
                      (d[b(f.feature.properties, e)] = c);
                  }
                } catch (g) {
                  console;
                }
                ...
                try {
                  if (!f.feature.properties.hasOwnProperty(e))
                    throw new Error(
                      "propertyName '" + e + "' not found in feature"
                    );
                  (c = f.getBounds().getCenter()),
                    (c.layer = f),
                    (d[f.feature.properties[e]] = c);
                } catch (g) {
                  console;
                }
              else
                f instanceof a.LayerGroup &&
                  f.eachLayer(function (a) {
                    (c = a.getLatLng()),
                      (c.layer = a),
                      (d[a.feature.properties[e]] = c);
                  });
          }, this),
          d
        );
